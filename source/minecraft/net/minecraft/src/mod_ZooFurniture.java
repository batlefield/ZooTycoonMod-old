...
public class mod_ZooFurniture extends BaseMod
{
	...
	public static Block makeBlock(Class blockClass, String idname, int id, Class tileClass, Material mat, float hard, String name)
	{
		try
		{
			return ((ZooFurnitureBase)(blockClass.getConstructors()[0]
			    .newInstance(getBlockID(idname, id),0,tileClass,mat)))
				.setHardness(hard)
				.setBlockName(name);
		}
		catch(Exception e)
	...
	{
		return new ZooItemFurniture(getItemID(idname, id), (ZooFurnitureBase)block)
		.setIconIndex(tex)
		.setItemName(name);
	...
	{
        ZooTileEntityFurnitureRenderer benchRenderer= new  ZooTileEntityFurnitureRenderer(
        		"/zoo/modells/Furniture/ModelWood.png",
        		ZooModelBench.class);
	...
	// Blocks/Items
	public static Block blockBench = makeBlock(ZooBlockBench.class, "Bench", 218,
			ZooTileEntityBench.class, Material.wood, 2.0f, "Block Bench"); 
