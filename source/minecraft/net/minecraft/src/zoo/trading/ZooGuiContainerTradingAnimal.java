...
public class ZooGuiContainerTradingAnimal extends GuiContainer
{
	...
	public ZooGuiContainerTradingAnimal(EntityPlayer player)
	{
	...
	public void handleMouseInput()
	{
		...
		if (i != 0 && ((ZooContainerTradingTools) inventorySlots).itemList.size() > 40)
		{
			int j = (((ZooContainerTradingTools) inventorySlots).itemList.size() / 8 - 5) + 1;
			if (i > 0)
			{
				i = 1;
			}
