...
public class ZooGuiContainerTradingTools extends GuiContainer
{
    ...
    public ZooGuiContainerTradingTools()
    {
        super(new ZooContainerTradingTools());
        currentScroll = 0.0F;
        isScrolling = false;
    ...
    public void initGui()
    {
        super.initGui();
        controlList.clear();
        ZooContainerTradingTools.interact = true;
    }

    public void actionPerformed(GuiButton guibutton)
    {
        ZooContainerTradingTools zoo = ZooContainerTradingTools.instance;
    }

    public void onGuiClosed()
    {
        ZooContainerTradingTools.interact = false;
    }
