...
public class ZooContainerTradingMod extends Container
{

    private static Minecraft minecraft = ModLoader.getMinecraftInstance();
    public static ZooContainerTradingMod instance = new ZooContainerTradingMod();
    public static boolean interact;
    public static List itemList;

    public ZooContainerTradingMod()
    {
        loadStacks();
    }
    ...
    public void loadStacks()
    {
        ...
        for(int l2 = 0; l2 < 5; l2++)
        {
            ...
            {
                addSlot(new Slot(ZooGuiContainerTradingMod.getInventory(), k3 + l2 * 8, 8 + k3 * 18, 18 + l2 * 18));
            }
    ...
    public void scrollTo(float f)
    {
        ...
        for(int k = 0; k < 9; k++)
        {
            for(int l = 0; l < 8; l++)
            {
                ...
                {
                    ZooGuiContainerTradingMod.getInventory().setInventorySlotContents(l + k * 8, (ItemStack)itemList.get(i1));
                } else
                {
                	ZooGuiContainerTradingMod.getInventory().setInventorySlotContents(l + k * 8, null);
                }
            }
    ...
    {
      List blocks = Trade.getBlocks(10);
      if (blocks != null)
      {
