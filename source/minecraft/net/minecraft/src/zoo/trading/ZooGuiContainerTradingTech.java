...
public class ZooGuiContainerTradingTech extends GuiContainer
{
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        if(isScrolling)
        {
            ...
            ((ZooContainerTradingTech)inventorySlots).scrollTo(currentScroll);
        }
    ...
    public void initGui()
    {
        super.initGui();
        controlList.clear();
        ZooContainerTradingTech.interact = true;
    }

    public void actionPerformed(GuiButton guibutton)
    {
        ZooContainerTradingTech zoo = ZooContainerTradingTech.instance;
    }

    public void onGuiClosed()
    {
        ZooContainerTradingTech.interact = false;
    }
    ...
    public void handleMouseInput()
    {
        ...
        if(i != 0 && ((ZooContainerTradingTech)inventorySlots).itemList.size() > 40)
        {
            int j = (((ZooContainerTradingTech)inventorySlots).itemList.size() / 8 - 5) + 1;
            if(i > 0)
            {
                i = 1;
            }
