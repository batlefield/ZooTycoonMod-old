...
public class ZooGuiContainerTradingPlants extends GuiContainer
{
    ...
    public ZooGuiContainerTradingPlants()
    {
        super(new ZooContainerTradingPlants());
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        if(isScrolling)
        {
            ...
            ((ZooContainerTradingPlants)inventorySlots).scrollTo(currentScroll);
        }
    ...
    public void initGui()
    {
        super.initGui();
        controlList.clear();
        ZooContainerTradingPlants.interact = true;
    }

    public void actionPerformed(GuiButton guibutton)
    {
        ZooContainerTradingPlants zoo = ZooContainerTradingPlants.instance;
    }

    public void onGuiClosed()
    {
        ZooContainerTradingPlants.interact = false;
    }
    ...
    public void handleMouseInput()
    {
        ...
        if(i != 0 && ((ZooContainerTradingPlants)inventorySlots).itemList.size() > 40)
        {
            int j = (((ZooContainerTradingPlants)inventorySlots).itemList.size() / 8 - 5) + 1;
            if(i > 0)
            {
                i = 1;
            }
