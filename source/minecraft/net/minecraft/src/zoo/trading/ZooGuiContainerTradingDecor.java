...
public class ZooGuiContainerTradingDecor extends GuiContainer
{
    ...
    public ZooGuiContainerTradingDecor()
    {
        super(new ZooContainerTradingDecor());
    ...
    public void initGui()
    {
        super.initGui();
        controlList.clear();
        ZooContainerTradingDecor.interact = true;
    }

    public void actionPerformed(GuiButton guibutton)
    {
        ZooContainerTradingDecor zoo = ZooContainerTradingDecor.instance;
    }

    public void onGuiClosed()
    {
        ZooContainerTradingDecor.interact = false;
    }
    ...
    public void handleMouseInput()
    {
        ...
        if(i != 0)
        {
            int j = (((ZooContainerTradingDecor)inventorySlots).itemList.size() / 8 - 8) + 1;
            if(i > 0)
            {
                i = 1;
            }
