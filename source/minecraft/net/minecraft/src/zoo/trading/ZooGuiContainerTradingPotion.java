...
public class ZooGuiContainerTradingPotion extends GuiContainer
{
    ...
    public ZooGuiContainerTradingPotion()
    {
        super(new ZooContainerTradingPotion());
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        if(isScrolling)
        {
            ...
            ((ZooContainerTradingPotion)inventorySlots).scrollTo(currentScroll);
        }
    ...
    public void initGui()
    {
        super.initGui();
        controlList.clear();
        ZooContainerTradingPotion.interact = true;
    }

    public void actionPerformed(GuiButton guibutton)
    {
        ZooContainerTradingPotion zoo = ZooContainerTradingPotion.instance;
    }

    public void onGuiClosed()
    {
        ZooContainerTradingPotion.interact = false;
    }
    ...
    public void handleMouseInput()
    {
        ...
        if(i != 0 && ((ZooContainerTradingPotion)inventorySlots).itemList.size() > 40)
        {
            int j = (((ZooContainerTradingPotion)inventorySlots).itemList.size() / 8 - 5) + 1;
            if(i > 0)
            {
                i = 1;
            }
