...
public class ZooGuiContainerTradingMod extends GuiContainer
{
    ...
    public ZooGuiContainerTradingMod()
    {
        super(new ZooContainerTradingMod());
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        if(isScrolling)
        {
            ...
            ((ZooContainerTradingMod)inventorySlots).scrollTo(currentScroll);
        }
    ...
    public void initGui()
    {
        super.initGui();
        controlList.clear();
        ZooContainerTradingMod.interact = true;
    }

    public void actionPerformed(GuiButton guibutton)
    {
        ZooContainerTradingMod zoo = ZooContainerTradingMod.instance;
    }

    public void onGuiClosed()
    {
        ZooContainerTradingMod.interact = false;
    }
    ...
    public void handleMouseInput()
    {
        ...
        if(i != 0)
        {
            int j = (((ZooContainerTradingMod)inventorySlots).itemList.size() / 8 - 8) + 1;
            if(i > 0)
            {
                i = 1;
            }
