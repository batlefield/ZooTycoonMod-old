...
public class ZooGuiContainerTradingDirt extends GuiContainer
{
    ...
    public ZooGuiContainerTradingDirt()
    {
        super(new ZooContainerTradingDirt());
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        if(isScrolling)
        {
            ...
            ((ZooContainerTradingDirt)inventorySlots).scrollTo(currentScroll);
        }
    ...
    public void initGui()
    {
        super.initGui();
        controlList.clear();
        ZooContainerTradingDirt.interact = true;
    }

    public void actionPerformed(GuiButton guibutton)
    {
        ZooContainerTradingDirt zoo = ZooContainerTradingDirt.instance;
    }

    public void onGuiClosed()
    {
        ZooContainerTradingDirt.interact = false;
    }
    ...
    public void handleMouseInput()
    {
        ...
        if(i != 0 && ((ZooContainerTradingDirt)inventorySlots).itemList.size() > 40)
        {
            int j = (((ZooContainerTradingDirt)inventorySlots).itemList.size() / 8 - 5) + 1;
            if(i > 0)
            {
                i = 1;
            }
