...
public class ZooGuiContainerTradingFencing extends GuiContainer
{
    ...
    public ZooGuiContainerTradingFencing()
    {
        super(new ZooContainerTradingFencing());
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        if(isScrolling)
        {
            ...
            ((ZooContainerTradingFencing)inventorySlots).scrollTo(currentScroll);
        }
    ...
    public void initGui()
    {
        super.initGui();
        controlList.clear();
        ZooContainerTradingFencing.interact = true;
    }

    public void actionPerformed(GuiButton guibutton)
    {
        ZooContainerTradingFencing zoo = ZooContainerTradingFencing.instance;
    }

    public void onGuiClosed()
    {
        ZooContainerTradingFencing.interact = false;
    }
    ...
    public void handleMouseInput()
    {
        ...
        if(i != 0 && ((ZooContainerTradingFencing)inventorySlots).itemList.size() > 40)
        {
            int j = (((ZooContainerTradingFencing)inventorySlots).itemList.size() / 8 - 5) + 1;
            if(i > 0)
            {
                i = 1;
            }
