...
public class ZooContainerTradingTech extends Container
{

    private static Minecraft minecraft = ModLoader.getMinecraftInstance();
    public static ZooContainerTradingTech instance = new ZooContainerTradingTech();
    public static boolean interact;
    public static List itemList;

    public ZooContainerTradingTech()
    {
        loadStacks();
    }
    ...
    public void loadStacks()
    {
        ...
        Block ablock[] =
            {
                Block.pistonBase, Block.pistonStickyBase, Block.button, Block.lever, Block.pressurePlatePlanks, Block.pressurePlateStone,
                Block.rail, Block.railDetector, Block.railPowered, Block.torchRedstoneActive, Block.dispenser
            };
        ...
        Item aitem[] = {
            Item.redstone, Item.redstoneRepeater, Item.doorWood, Item.doorSteel, Item.minecartEmpty, Item.minecartCrate, Item.minecartPowered
        };
        ...
        for(int l2 = 0; l2 < 5; l2++)
        {
            ...
            {
                addSlot(new Slot(ZooGuiContainerTradingTech.getInventory(), k3 + l2 * 8, 8 + k3 * 18, 18 + l2 * 18));
            }
    ...
    public void scrollTo(float f)
    {
        ...
        for(int k = 0; k < 9; k++)
        {
            for(int l = 0; l < 8; l++)
            {
                ...
                {
                    ZooGuiContainerTradingTech.getInventory().setInventorySlotContents(l + k * 8, (ItemStack)itemList.get(i1));
                } else
                {
                	ZooGuiContainerTradingTech.getInventory().setInventorySlotContents(l + k * 8, null);
                }
            }
