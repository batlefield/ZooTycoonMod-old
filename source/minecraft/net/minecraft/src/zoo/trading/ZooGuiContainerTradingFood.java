...
public class ZooGuiContainerTradingFood extends GuiContainer
{
    ...
    public ZooGuiContainerTradingFood()
    {
        super(new ZooContainerTradingFood());
   ...
   protected void handleMouseClick(Slot slot, int i, int j, boolean flag)
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        if(isScrolling)
        {
            ...
            ((ZooContainerTradingFood)inventorySlots).scrollTo(currentScroll);
        }
    ...
    public void initGui()
    {
        super.initGui();
        controlList.clear();
        ZooContainerTradingFood.interact = true;
    }

    public void actionPerformed(GuiButton guibutton)
    {
        ZooContainerTradingFood zoo = ZooContainerTradingFood.instance;
    }

    public void onGuiClosed()
    {
        ZooContainerTradingFood.interact = false;
    }
    ...
    public void handleMouseInput()
    {
        ...
        if(i != 0 && ((ZooContainerTradingFood)inventorySlots).itemList.size() > 40)
        {
            int j = (((ZooContainerTradingFood)inventorySlots).itemList.size() / 8 - 5) + 1;
            if(i > 0)
            {
                i = 1;
            }
