...
public class ZooEntityGreyWolf extends EntityTameable
{
    /**
    ...
    public ZooEntityGreyWolf(World par1World)
    {
        super(par1World);
     ...
     */
    public void setTarget(EntityLiving par1EntityLiving)
    {
        super.setTarget(par1EntityLiving);
    ...
    {
        ZooEntityGreyWolf var2 = new ZooEntityGreyWolf(this.worldObj);
    ...
    public boolean func_48135_b(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof ZooEntityGreyWolf))
        {
            return false;
        }
        else
