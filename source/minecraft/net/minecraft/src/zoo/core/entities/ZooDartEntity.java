...
public class ZooDartEntity extends Entity
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public ZooDartEntity(World par1World)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    }

    public ZooDartEntity(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.setSize(0.5F, 0.5F);
    ...
    public ZooDartEntity(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
    ...
    public ZooDartEntity(World par1World, EntityLiving par2EntityLiving, float par3)
    {
        super(par1World);
        this.shootingEntity = par2EntityLiving;
        this.doesArrowBelongToPlayer = par2EntityLiving instanceof EntityPlayer;
        ...
        else
        {
            ...
            if (var3 != null)
            {
                if (var3.entityHit != null)
                {
                    ...
                    {
                        var22 = (new EntityDamageSourceIndirect("dart", this, shootingEntity)).setProjectile();
                    }
                    
                    TaggedEntitiesSave.setTagged(var3);
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        ...
        {
            if (this.inGround && this.doesArrowBelongToPlayer && this.arrowShake <= 0 && par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Zoo.dart, 1)))
            {
