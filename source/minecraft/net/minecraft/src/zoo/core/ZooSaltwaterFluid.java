...
//            Block, LAPI, World, IBlockAccess, 
//            Material, mod_LAPI, Vec3D, AxisAlignedBB, 
//            Entity

public class ZooSaltwaterFluid extends Block implements ITextureProvider
{


    protected ZooSaltwaterFluid(int i,  Material material)
    {
        super(i, material);
        float f = 0.0F;
        float f1 = 0.0F;
    ...
    public static double func_293_a(IBlockAccess iblockaccess, int i, int j, int k, Material material)
    {
        ...
        {
            vec3d = ((ZooSaltwaterFluid)Block.waterMoving).getFlowVector(iblockaccess, i, j, k);
        }
        if(material == Material.lava)
        {
            vec3d = ((ZooSaltwaterFluid)Block.lavaMoving).getFlowVector(iblockaccess, i, j, k);
        }
