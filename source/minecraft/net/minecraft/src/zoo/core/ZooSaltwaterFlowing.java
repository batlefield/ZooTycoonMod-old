...
//            BlockFluidLAPI, LAPI, World, Material, 
//            WorldProvider, Block, IBlockAccess

public class ZooSaltwaterFlowing extends ZooSaltwaterFluid implements ITextureProvider
{
    ...
    public ZooSaltwaterFlowing(int i, Material material)
    {
        super(i, material);
