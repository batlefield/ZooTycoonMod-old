...
import net.minecraft.src.zoo.core.modells.ZooModelHippo;

import org.lwjgl.opengl.GL11;

public class ZooRenderHippo extends RenderLiving
{

	private static byte height = -80;
	
    public ZooRenderHippo(float f)
    {
        super(new ZooModelHippo(), f);
    }
