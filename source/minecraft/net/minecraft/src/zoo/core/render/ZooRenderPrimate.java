...
import net.minecraft.src.zoo.core.modells.ZooModelPrimate;

import org.lwjgl.opengl.GL11;

public class ZooRenderPrimate extends RenderLiving
{

	private static byte height = -80;
	
    public ZooRenderPrimate(float f)
    {
        super(new ZooModelPrimate(), f);
    }
