...
import net.minecraft.src.zoo.core.models.ZooModelLionFemale;

import org.lwjgl.opengl.GL11;

public class ZooRenderFemaleLion extends RenderLiving
{

	private static byte height = -80;
	
    public ZooRenderFemaleLion(float f)
    {
        super(new ZooModelLionFemale(), f);
    }
