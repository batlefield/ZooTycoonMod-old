...
import net.minecraft.src.zoo.core.modells.ZooModelPanther;

import org.lwjgl.opengl.GL11;

public class ZooRenderPanter extends RenderLiving
{

	private static byte height = -80;
	
    public ZooRenderPanter(float f)
    {
        super(new ZooModelPanther(), f);
    }
