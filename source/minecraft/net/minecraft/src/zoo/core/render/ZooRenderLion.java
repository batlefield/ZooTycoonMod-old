...
import net.minecraft.src.zoo.core.modells.ZooModelLion;

import org.lwjgl.opengl.GL11;

public class ZooRenderLion extends RenderLiving
{

	private static byte height = -80;
	
    public ZooRenderLion(float f)
    {
        super(new ZooModelLion(), f);
    }
