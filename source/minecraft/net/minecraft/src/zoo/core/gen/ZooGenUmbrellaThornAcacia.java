...
public class ZooGenUmbrellaThornAcacia extends WorldGenerator
{
    ...
    public boolean generate(World world, Random random, int i, int j, int k)
    {
        ...
        for(int l1 = 0; l1 < l; l1++)
        {
            ...
            if(k2 == 0 || k2 == Zoo.acaciaLeaves.blockID)
            {
                ...
                setBlockAndMetadata(world, i + 2, h + 3, k - 2, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i + 2, h + 3, k - 3, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i + 3, h + 3, k - 2, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i + 3, h + 3, k - 3, Zoo.acaciaLeaves.blockID, 0);

                setBlockAndMetadata(world, i, h + 4, k + 2, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i, h + 4, k - 2, Zoo.acaciaLeaves.blockID, 0);
                ...
                setBlockAndMetadata(world, i + 2, h + 3, k + 4, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 4, h + 3, k - 2, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 2, h + 3, k - 4, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i + 4, h + 3, k - 2, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i + 2, h + 3, k - 4, Zoo.acaciaLeaves.blockID, 0);
                ...
                setBlockAndMetadata(world, i - 2, h + 3, k - 5, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 3, h + 3, k - 4, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 4, h + 3, k - 3, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 5, h + 3, k - 2, Zoo.acaciaLeaves.blockID, 0);
                
                //generating ends
                setBlockAndMetadata(world, i + 3, h + 4, k + 1, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i + 3, h + 4, k - 1, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i + 3, h + 4, k, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i + 4, h + 4, k, Zoo.acaciaLeaves.blockID, 0);
                
                setBlockAndMetadata(world, i + 1, h + 4, k + 3, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 1, h + 4, k + 3, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i, h + 4, k + 3, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i, h + 4, k + 4, Zoo.acaciaLeaves.blockID, 0);
                
                setBlockAndMetadata(world, i - 3, h + 4, k, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 3, h + 4, k + 1, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 3, h + 4, k - 2, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 3, h + 4, k - 1, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 4, h + 4, k - 1, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 4, h + 4, k, Zoo.acaciaLeaves.blockID, 0);
                
                setBlockAndMetadata(world, i, h + 4, k - 3, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i + 1, h + 4, k - 3, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 2, h + 4, k - 3, Zoo.acaciaLeaves.blockID, 0);
                setBlockAndMetadata(world, i - 1, h + 4, k - 3, Zoo.acaciaLeaves.blockID, 0);
