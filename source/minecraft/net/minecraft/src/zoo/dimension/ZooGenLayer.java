...
public abstract class ZooGenLayer extends GenLayer{

	public ZooGenLayer(long l) {
		super(l);
	}
	...
	public static GenLayer[] func_48425_a(long par0, WorldType par2WorldType)
    {
        ...
        GenLayer var6 = GenLayerZoom.func_35515_a(1000L, var10, 0);
        ZooGenLayerBiome var15 = new ZooGenLayerBiome(200L, var6);
