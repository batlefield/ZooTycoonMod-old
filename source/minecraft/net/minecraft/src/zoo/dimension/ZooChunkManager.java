...
public class ZooChunkManager extends WorldChunkManager
{
    ...
    protected ZooChunkManager()
    {
        this.biomeCache = new BiomeCache(this);
        this.biomesToSpawnIn = new ArrayList();
        for(Object o : Biome.getBiomes(2))
        {
        	biomesToSpawnIn.add(o);
        }
    }

    public ZooChunkManager(long par1, WorldType par3WorldType)
    {
        this();
        GenLayer[] var4 = ZooGenLayer.func_48425_a(par1, par3WorldType);
        this.genBiomes = var4[0];
        this.biomeIndexLayer = var4[1];
    }

    public ZooChunkManager(World par1World)
    {
