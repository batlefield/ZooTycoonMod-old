...
public class ZooBiomeBase extends BiomeGenBase{
	...
	public static final BiomeGenBase mesa = (new ZooDimMesa(ZooPlatform.getFreeBiomeID(251))).setColor(0xFFEF00).setBiomeName("Mesa").setDisableRain().setTemperatureRainfall(2.0F, 0.0F).setMinMaxHeight(0.1F, -0.1F);
